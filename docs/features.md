...
| [Brain](api-reference.md#spatial-memory-cli-only) | One command for full colony picture: DC, faction, summary, building roles, tree/food clusters, maps, tasks. Persists to toon format | Yes |
